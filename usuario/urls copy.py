...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name='registration/password_reset_form.html', success_url=reverse_lazy('usuario:password_reset_done')), name='password_reset'),
