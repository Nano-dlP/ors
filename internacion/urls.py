...
urlpatterns = [
    ...
    path("dashboard/motivo-alta/", dashboard_motivo_alta, name="dashboard_motivo_alta"),
    path('internacion/eliminar/<int:pk>/', views.InternacionDeleteView.as_view(), name='internacion_delete'),
]