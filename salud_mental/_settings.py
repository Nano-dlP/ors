...
# Producción: leer secretos, pero evitar que una clave faltante rompa la importación
if DEBUG:
    # Desarrollo → imprime mails en consola
    EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
else:
    # Producción → intenta leer desde get_secret y, si falta, usar variables de entorno / fallback
    try:
        ...
        # Fallback razonable para tareas de mantenimiento (collectstatic, etc.)
        # En producción debes proveer los secretos reales (preferible via env vars o gestor de secretos).
